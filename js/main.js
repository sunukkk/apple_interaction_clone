    ...
    //sceneInfo[2]
      {
        ...
        objs: {
          ...
          msgA: document.querySelector('#scroll-section-2 .main-message.msg-a'),
        ...
        values: {
          ...
          msgB_TranslateY_out: [0, -20, { start: 0.6, end: 0.65 }],
      
          msgC_Opacity_in: [0, 1, { start: 0.7, end: 0.75 }],
          msgC_TranslateY_in: [20, 0, { start: 0.7, end: 0.75 }],
